...
const NewsSearch = () => {
    ...
    return (
        <div className="newsSearchBody">
            {(news[0] !== undefined && news[0].results !== undefined) ? news[0].results.stories.map((i, index) => {
                console.log(i)
                return (
                                    ...
                                    <div className="col-lg-8 col-md-6 col-sm-12">
                                        <div className="card noBo">
                                            <div className="card-body">
                                                ...
                                                <p>{i.excerpt.split('').slice(0, 100).join('')}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-6 col-sm-12">
                                        <div className="card noBo imgCard p-3">
                                            <img src={i.image_url} alt="" className="card-img-top imgCard" />
                                        </div>
                                    </div>
                                </div>
                            </div>
